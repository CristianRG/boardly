<template>
    <div class="content">
        ...
        <span v-if="!state">Share this url with your team:</span>
        <span v-if="state">Share this url with your team: <router-link :to="`/share/${store.board.id}`">{{ url }}</router-link></span>
        <span v-if="state">State: Online</span>
